...
function initialize() {
 ...
 //Loads the script to get everything going
function loadScript() {

    var script = document.createElement("script");
    script.type = "text/javascript";
    script.src = "http://maps.googleapis.com/maps/api/js?key=AIzaSyCLowdBlSofNqpeTgNlQPpuXepCAWAuUNo&sensor=true&callback=initialize";
